...
import ec.edu.uce.renderers.RenderPiramideMundo;

public class Activity_Piramide_Mundo extends Activity {
    ...
    private RenderPiramideMundo renderPiramide;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        renderPiramide = new RenderPiramideMundo();
